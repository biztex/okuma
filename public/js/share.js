        ...
        function() {
            ...
            window.jQuery = window.$ = e(), e()((function() {
                ...
                Ho("(max-width: 768px)", (function(t) { t.matches ? o.update({ header: "[data-scroll-header]" }) : o.update({ header: ".global-navi__list" }) })), Mn(), n = window.innerWidth, setTimeout(In, 200), window.addEventListener("resize", (function() { setTimeout((function() { n != window.innerWidth && (In(), n = window.innerWidth) }), 200) })),
                    ...
                    function() {
                        if (e()(".js-bookly").length) {
                            var t = e()(".pages").children();
                            t.each((function(i) {
                                var n = e()(this);
                                ...
                                e()(".page").on("click", (function() {
                                    ...
                                    if (2 == n) return !1;
                                    if (7 == n) return !1;
                                    n % 2 == 0 ? (i.removeClass("flipped"), i.prev().removeClass("flipped")) : (i.addClass("flipped"), i.next().addClass("flipped")), vn.set(".p-top__quality-control button", { autoAlpha: 1 });
                                    var o = t.index(e()(".page.flipped").last()) + 1;
                                    2 == o && vn.to(".js-bookly-back", { autoAlpha: 0, duration: .25 }), 6 == o && vn.to(".js-bookly-next", { autoAlpha: 0, duration: .25 })
                                })).first().trigger("click"), e()(".js-bookly-next").on("click", (function(t) { t.preventDefault(), e()(".page.flipped").last().next().trigger("click") })), e()(".js-bookly-back").on("click", (function(t) { t.preventDefault(), e()(".page.flipped").last().trigger("click") })), e()(".book").addClass("bound")
                            }))
                        }
